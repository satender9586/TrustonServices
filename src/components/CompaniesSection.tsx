...
const CompaniesSection = () => {
  return (
    <section className="bg-gradient-to-b from-[#fffafc] via-white to-[#fef6f9] py-5 sm:pt-8">
      <div className="container mx-auto px-4 sm:px-10  text-center ">
        ...
        <p className="md:hidden text-[15px] tracking-wide sm:text-[16px] text-[#555] leading-relaxed pb-4 px-2">
          Trusted by leading brands for consistent, high-quality appliance repair 
          & maintenance 
        </p>
        <p className="hidden md:block text-[15px] tracking-wide sm:text-[16px] text-[#555] leading-relaxed pb-4 px-2">
          Trusted by leading brands for consistent, high-quality appliance repair 
