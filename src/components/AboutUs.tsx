    ...
    <div className="w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div>
              ...
              <p className="text-[16px] sm:text-[17px] text-[#444] font-light leading-relaxed tracking-wide mb-6">
                ...
                , we deliver expert-level repair, installation, and maintenance
                services for all major home appliances. With a trusted team of
                certified technicians and{" "}
                <span className="font-semibold text-[#AF0D5A]">7+ years</span>{" "}
                of industry experience, we bring reliability, speed, and
                professionalism right to your doorstep.
                <br />
                <br />
                From air conditioners and refrigerators to washing machines and
                more — our mission is simple: to keep your home running smoothly
                and stress-free across Delhi NCR.
              </p>
      ...
      <section className="bg-gradient-to-r from-[#fdf4f8] to-[#fff] py-6 md:py-14">
        <div className="container mx-auto px-4 sm:px-6 lg:px-20">
          ...
          <p className="max-w-2xl mx-auto text-center text-[15px] sm:text-[16px] text-[#777] md:mb-8">
            Our partnerships with top companies reflect our commitment to
            consistent, high-quality home service.
          </p>
