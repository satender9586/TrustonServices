  ...
  return (
      ...
      <section className="relative bg-gradient-to-br from-[#ffffff] via-[#fff3f8] to-[#fdf4f8] py-14 md:py-10 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-10 text-center max-w-3xl">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif  md:font-extrabold text-[#AF0D5A] mb-4">
            Who We Are
          </h2>
         

   
          <p className="text-[14px] sm:text-[16px] text-[#555] leading-relaxed mb-8 font-serif">
            At <span className="text-[#AF0D5A] font-semibold">Trust On Services</span>, we provide expert repair, installation, 
            and maintenance. 
          </p>
          <p className="hidden md:block text-[15px] sm:text-[16px] text-[#555] leading-relaxed mb-8 font-serif">
            At <span className="text-[#AF0D5A] font-semibold">Trust On Services</span>, we provide expert repair, installation, 
