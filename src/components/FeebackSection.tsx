      ...
      <section className="bg-gradient-to-b from-[#fffafc] via-white to-[#fef6f9] py-5 sm:py-8">
        <div className="container mx-auto px-4 sm:px-10  text-center ">
          <div>
            ...
            <p className="md:hidden  text-[15px] tracking-wide sm:text-[16px] text-[#747474] leading-relaxed pb-4">
              Our customers love us for our quality, professionalism,
            </p>
            <p className="hidden md:block  text-[15px] tracking-wide sm:text-[16px] text-[#747474] leading-relaxed pb-4">
