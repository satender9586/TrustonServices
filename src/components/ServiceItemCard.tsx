...
const ServiceItemCard: React.FC<ServiceCardProps> = ({ itemUrl, itemName, itemDesc }) => {
  return (
  <div className="max-w-sm bg-white rounded-[20px_5px_20px_5px] shadow-md overflow-hidden hover:border-[#AF0D5A] hover:shadow-lg hover:-translate-y-1 transition duration-300 border border-gray-100">
